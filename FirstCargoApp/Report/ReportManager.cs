...
namespace FirstCargoApp.Report
{
    public class ReportManager
    {
        ...
        public void generateListOfOrderWithPreis(object dataTable)
        {
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
               ...
               /* phrase = new Phrase();
                ...
                phrase = new Phrase();
                phrase.Add(new Chunk(@ViewResources.Resource.bill + @ViewResources.Resource.OrderNumber + ": " + "orderNumber", FontFactory.GetFont("Arial", 13, Font.BOLD, BaseColor.BLACK)));
                cell = PhraseCell(phrase, PdfPCell.ALIGN_LEFT);
                cell.VerticalAlignment = PdfPCell.ALIGN_TOP;
                table.AddCell(cell);
                document.Add(table);
